...
using Demo.Statistics.Infrastructure.StatisticsMiddleware;
...
namespace Demo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<StatisticsAppDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("StatisticsAppDbContext")));
        ...
        private IAnalyticStore GetAnalyticStore()
        {
            ...
            //new SqLiteAnalyticStore("Data Source = stat.db");

            return new SqlServerAnalyticStore(
                @"Server=SINJULMSBH\MSSQLSERVER2016;Database=test;Trusted_Connection=True;")
