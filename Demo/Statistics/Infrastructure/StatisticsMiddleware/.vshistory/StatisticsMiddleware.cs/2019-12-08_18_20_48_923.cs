...
using Offishopp.Infrastructures.DataAccess.DatabaseContext;
using Offishopp.Presentation.Security.Extensions;
		...
		private string GetCurrentIpAddress(HttpContext context)
		{
			...
			try
			{
				...
				if (context.Request.Headers != null)
				{
					...
					var forwardedHeader = context.Request.Headers[forwardedHttpHeaderKey];
